return PlaceObj('ModDef', {
	...
	'last_changes', "1. First pass on weapon balance\n2. AP indicator calculates AP correctly at all times\n3. Launch grenade should be fixed",
	'id', "Db7c5fd",
