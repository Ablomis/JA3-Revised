return PlaceObj('ModDef', {
	...
	'last_changes', "Updated weapon parameters in the modify page dialog",
	'dependencies', {},
	'id', "Db7c5fd",
	...
	'code', {
		...
		"Code/CombatMovementContour.lua",
		...
		"Code/GetWeaponModifyProperties.lua",
		...
		"Code/XTemplateModifyWeaponDlg.lua",
