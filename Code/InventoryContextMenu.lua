    ...
    PlaceObj("XTemplateWindow", {
      ...
      PlaceObj("XTemplateWindow", {
        ...
        PlaceObj("XTemplateGroup", {
          ...
          "__condition",
          function(parent, context)
            return context and ((context.item:IsWeapon() and IsKindOf(context.item, "Firearm")) or IsKindOf(context.item, "Mag"))
          end
        }, {
          PlaceObj("XTemplateTemplate", {
            "comment",
          ...
          PlaceObj("XTemplateTemplate", {
            ...
            function(self, gamepad)
              ...
              local cost_ap = InventoryIsCombatMode() and item.ReloadAP or 10
        ...
        PlaceObj("XTemplateTemplate", {
          ...
          function(parent, context)
            ...
            if context.item:IsKindOf('Mag') then return false end
