...
DefineClass.RPK74 = {
	...
	DisplayName = T(221960774258, --[[ModItemInventoryItemCompositeDef RPK74 DisplayName]] "RPK-74"),
	DisplayNamePlural = T(898360901563, --[[ModItemInventoryItemCompositeDef RPK74 DisplayNamePlural]] "RPK-74s"),
	Description = T(488855541962, --[[ModItemInventoryItemCompositeDef RPK74 Description]] "Built upon the AK platform with a thicker barrel and other small changes to allow for better sustained fire capability. This general purpose machine gun is meant to be a squad force multiplier with easy operation, integration, and ammo compatibility with other AK weapons."),
	AdditionalHint = T(717103167762, --[[ModItemInventoryItemCompositeDef RPK74 AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Slower Condition loss"),
	LargeItem = true,
